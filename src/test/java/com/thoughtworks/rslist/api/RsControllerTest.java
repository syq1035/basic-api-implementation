...
class RsControllerTest {
    ...
    void should_add_rs_event_when_user_exists() throws Exception {
        ...
        mockMvc.perform(post("/rs").content(json).contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    void should_edit_rs_event_by_id() throws Exception {
        ...
        mockMvc.perform(put("/rs/{id}", rsEventEntity.getId()).content(json).contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isOk());
    ...
    void should_vote() throws Exception {
        ...
        mockMvc.perform(post("/rs/vote/{id}", rsEventEntity.getId()).content(json).contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isCreated());
